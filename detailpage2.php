...
echo '
    ...
    <meta http-equiv="Expires" content="Mon, 26 Jul 2020 05:00:00 GMT">
...
<div id="wrapper" class="wrapper clearfix">
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-9">
                        ...
                        $result = mysqli_query($con,"SELECT * FROM products WHERE productcode='$productcode ' limit 1"); 
 ...
 $var=$row['id'];   
                        echo '
							...
							<img src="images/products/'.$row['img'].'" alt="product image"> 
...
?>
 ...
 <a class="btn btn-primary" href="javascript:void(0)" data-wishlist="8" title="Add to Wishlist" onclick="addToWishlist(\'' . $row['img'] . '\', \'' . $row['name'] . '\', \'' . $row['price'] . '\', \'' . $_SESSION['userSession'] . '\', \'' . $row['id'] . '\')" > <span>Wishlist</span> </a>
					...
					<div class="product-share  text-center-xs">
						...
						<a class="share-facebook" href="https://www.facebook.com/sharer.php?u=http://meganceengland.uk/detailpage.php?q='.$row['id'].'"  target="_blank" ><i class="fa fa-facebook"></i></a>
					
						<a class="share-twitter" href="http://twitter.com/share?text='.$row['name'].'&url=http://meganceengland.uk/detailpage.phpq='.$row['id'].'" target="_blank"><i class="fa fa-twitter"></i></a>
					
						<a style="background-color:#25D366" href=""><i class="fa fa-whatsapp"></i></a>
							</div>
