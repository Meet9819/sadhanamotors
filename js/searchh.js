...
function filterSearch() {
	...
	$.ajax({
		...
		method: "POST",
		dataType: "json",
		data: { actionn: actionn, aa: aa, title: title, parentid: parentid, minPrice: minPrice, maxPrice: maxPrice, maincat: maincat, color: color, categoryid: categoryid, },
