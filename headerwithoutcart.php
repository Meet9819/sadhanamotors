...
<!-- SESSION CODE | Login karne k baad --> 
                ...
                if(isset($_SESSION['userSession']))
                {
                 echo '  
                             ...
                             <li class="dropdown"> 
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">  '.$row['userEmail'].' <i class="fa fa-angle-down"></i></a>
 ...
 <li>
                             ...
                             <li>
                                <a href="history.php">Your Order</a>
                            </li>
                                   
                                     <li>
                                        <a href="" >Hello, '.$row['userName'].'</a> 
                                    </li>
